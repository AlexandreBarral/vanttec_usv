...
class AutoNav:
    def __init__(self):
        ...
        self.path_pub = rospy.Publisher('/usv_control/los_avoidance/mission_waypoints', Float32MultiArray, queue_size=10)
        self.status_pub = rospy.Publisher("/rb_missions/mission/status", Int32, queue_size=10)
        self.test = rospy.Publisher("/rb_missions/mission/test", Int32, queue_size=10)
