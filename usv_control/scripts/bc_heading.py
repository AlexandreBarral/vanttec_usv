...
#Desired values subscribers
        rospy.Subscriber("/usv_control/guidance/desired__heading", Float64, self.dheading_callback)
        rospy.Subscriber("/usv_control/guidance/desired_thrust", Float64, self.dthrust_callback)
